...
void loop() {
  ...
  if (anyUsedSensor) {
    ...
    if (ok1) {
      ...
      Serial.print(h1, 1);
      Serial.print("%");
      Serial.print(USE_SENSOR_1_IN_AVERAGE ? " [AVG]" : " [PRINT]");
    } else {
      Serial.print("ERR");
    }
    ...
    if (ok2) {
      ...
      Serial.print(h2, 1);
      Serial.print("%");
      Serial.print(USE_SENSOR_2_IN_AVERAGE ? " [AVG]" : " [PRINT]");
    } else {
      Serial.print("ERR");
    }
    ...
    if (ok3) {
      ...
      Serial.print(h3, 1);
      Serial.print("%");
      Serial.print(USE_SENSOR_3_IN_AVERAGE ? " [AVG]" : " [PRINT]");
    } else {
      Serial.print("ERR");
    }
    ...
    if (ok4) {
      ...
      Serial.print(h4, 1);
      Serial.print("%");
      Serial.print(USE_SENSOR_4_IN_AVERAGE ? " [AVG]" : " [PRINT]");
    } else {
      Serial.print("ERR");
    }
